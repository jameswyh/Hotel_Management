<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="orderinfo.aspx.cs" Inherits="orderinfo1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="住客信息">
             <ItemTemplate>
             <asp:Label ID="Label1" runat="server" Text="住客姓名" Width="70px"></asp:Label>
             <ajaxToolkit:HoverMenuExtender ID="HoverMenuExtender2" runat="server" TargetControlID="Label1"
                ...
                <asp:Panel ID="panel2" runat="server" style="height:150px;width:400px;padding:20px;" BorderWidth="3px" BorderStyle="Solid" BorderColor="#999999" BackColor="White">
                    <div style="margin-bottom:20px;">
                        <asp:Label ID="Label2" runat="server" Text="住客姓名" Font-Bold="true"></asp:Label>
                    <br/>
                    </div>
                    <div style="margin-bottom:20px;">
            ...
            <asp:CommandField SelectText="取消订单" ShowSelectButton="True" >
            <ItemStyle HorizontalAlign="Center" Width="100px" />
            </asp:CommandField>
        </Columns>
